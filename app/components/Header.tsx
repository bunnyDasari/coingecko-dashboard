                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between h-auto sm:h-16 gap-3 sm:gap-0 py-3 sm:py-0">
                    ...
                    <div className="w-full sm:flex-1 sm:max-w-2xl sm:mx-8">
                        <div className="relative">
                            ...
                            />
                            <button
                                className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-sm sm:text-base transition-all cursor-pointer"
                                onClick={onClickBtn}
                            >
                                Search
                            </button>
